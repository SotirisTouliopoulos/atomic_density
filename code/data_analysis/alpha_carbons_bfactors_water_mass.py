...
for file in ./*.pdb ; do python3 alpha_carbons_bfactors_water_mass.py ''$file'' >> alpha_carbons_bfactors_water_mass.counts ; done
"""


def total_alpha_carbons(pdb_file):
    """
    This function counts the total number of alpha carbons in all models of a PDB file.
    """
...
def median_bfactor(pdb_file):
    """
    This function calculates the median B-factor of all atoms in all models of a PDB file.
    """
    parser = PDBParser(QUIET=True)
    structure = parser.get_structure("structure", pdb_file)
...
def total_water_mass(pdb_file):
    """
    This function calculates the total mass of water molecules in a PDB file.
    """
    water_mass = 18.01528
...
# Water Mass is normalized by the number of alpha carbons
# This is done to get a value that is comparable across different PDB files
