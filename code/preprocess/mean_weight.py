...
for file in ./*.pdb ; do python3 mean_weight.py ''$file'' ; done
"""

# This script is used to calculate the averahe weight of the atoms in a PDB file.
# The output is used in the Z_parser.py to assign weight to unknown atoms.
